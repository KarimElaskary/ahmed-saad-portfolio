...
import massagejedah from "../assets/massagejedah.jpeg";
...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Designed and developed a modern e-commerce store for Flora Gallery, a handmade jewelry brand. The project focused on creating a premium shopping experience through custom UI design, responsive layouts, HTML/CSS customization, brand identity implementation, and user-centered design. Every detail was crafted to reflect the brand's elegant and natural aesthetic while ensuring a smooth and intuitive user experience",
  ...
  },
  {
    ...
    description:
      "Designed and developed a complete e-commerce experience for Otakuverse, an anime fashion brand. The project included UI/UX design, responsive web layouts, HTML/CSS customization, brand identity integration, product page optimization, and user journey enhancements. The final result delivers a visually engaging shopping experience that captures the spirit of anime culture while maintaining usability, performance, and accessibility.",
      ...
      <div className="container mx-auto">
        <div className="text-center space-y-4 mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-bold">
            Live <span className="text-white/60">Projects</span>
          </h1>
        </div>
